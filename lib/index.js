...
class Brick extends EventEmitter {
  ...
  /**
   * This method should be override only by child Bricks that need initialization before being plugged into the flow
  ...
  /**
   * This method should be override only by child Bricks that directly publish data to the flow
