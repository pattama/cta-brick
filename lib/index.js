...
class Brick {
  ...
  constructor(cementHelper, config) {
    ...
    this.logger = cementHelper !== null && typeof cementHelper === 'object' && 'logger' in cementHelper ? cementHelper.logger : defaultLogger();
   ...
   * @return {Promise|*} - promise or anything
   * @example
   * as a test, we can simulate a random delay
   ...
   * */
  init() {
    this.logger.info(`Initialized Brick ${this.name}.`);
    return 'ok';
  }
